// V-2: Select component corrigido - 2025-09-11
// Fixed: Removido aninhamento incorreto de selects e props inválidas
// Implementação limpa com suporte completo ao padrão shadcn/ui
